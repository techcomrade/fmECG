...
import { deleteData, getData, loadStatus, updateData } from '../../redux/reducer/userSlice';
...
const DataTable = () => {
    ...
    const rowSelection = {
        onChange: (selectedRowKeys, selectedRows) => {
            ...
            delBtn.onclick = () => {
                showDeleteConfirm(table, selectedRowKeys[0]);
            }
    ...
    return (
        <>
            ...
            <Table rowSelection={{
                ...
                bordered columns={column} dataSource={tableData}/>
                ...
                <br />
                    {column.map(column => 
                        <Col span={22} >
                            ...
                            <Input name={column.dataIndex} value={dataEdit[column.dataIndex]} onChange={(e) => handleChangeInput(column.dataIndex, e.target.value)} />
                            </Form.Item>
                        </Col>
                    )}
            </Modal>
