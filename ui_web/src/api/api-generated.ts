...
export class RevenueControllerClient {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Successful
     */
    getAllRevenue(): Promise<RevenueResponse[]> {
        let url_ = this.baseUrl + "/revenue";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllRevenue(_response);
        });
    }

    protected processGetAllRevenue(response: Response): Promise<RevenueResponse[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(RevenueResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return Promise.resolve<RevenueResponse[]>(null as any);
    }

    /**
     * @return Successful
     */
    addRevenue(body: RevenueRequest): Promise<boolean> {
        let url_ = this.baseUrl + "/revenue";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processAddRevenue(_response);
        });
    }

    protected processAddRevenue(response: Response): Promise<boolean> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 201) {
            return response.text().then((_responseText) => {
    ...
    getTotalRevenue(): Promise<number> {
        let url_ = this.baseUrl + "/revenue/total";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetTotalRevenue(_response);
        });
    }

    protected processGetTotalRevenue(response: Response): Promise<number> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    getRevenueStatistic(year: number): Promise<number> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetRevenueStatistic(_response);
        });
    }
     ...
     * @return Successful
     */
    updateIRevenueById(id: string, body: RevenueRequest): Promise<boolean> {
        let url_ = this.baseUrl + "/revenue/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUpdateIRevenueById(_response);
        });
    }

    protected processUpdateIRevenueById(response: Response): Promise<boolean> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Successful
     */
    deleteRevenueById(id: string): Promise<boolean> {
        let url_ = this.baseUrl + "/revenue/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDeleteRevenueById(_response);
        });
    }

    protected processDeleteRevenueById(response: Response): Promise<boolean> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class RevenueResponse implements IRevenueResponse {

    [key: string]: any;

    constructor(data?: IRevenueResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RevenueResponse {
        data = typeof data === 'object' ? data : {};
        let result = new RevenueResponse();
        result.init(data);
        return result;
    }
...
export class RevenueRequest implements IRevenueRequest {
    ...
    /** The unique identifier for the user (patient) */
    patient_id!: string;
    /** The unique identifier for the user (doctor) */
    doctor_id?: string;
    /** Type of the service */
    serviceType!: number;
    ...
    constructor(data?: IRevenueRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.id = _data["id"];
            this.schedule_id = _data["schedule_id"];
            this.schedule_type = _data["schedule_type"];
            this.patient_id = _data["patient_id"];
            this.doctor_id = _data["doctor_id"];
    ...
    static fromJS(data: any): RevenueRequest {
        data = typeof data === 'object' ? data : {};
        let result = new RevenueRequest();
        result.init(data);
        return result;
    }
