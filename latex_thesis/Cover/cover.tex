...
\begin{titlepage}
  ...
  \end{figure}
  \vspace{1.5cm}
  \fontsize{24pt}{0pt}\selectfont BÁO CÁO \\ %THAY ĐỔI FONTSIZE VÀ XUỐNG DÒNG
  \vspace{12pt}
  \textbf{\fontsize{32pt}{0pt}\selectfont THỰC TẬP KỸ THUẬT} % IN ĐẬM THAY ĐỔI FONTSIZE
  \vspace{1.5cm}
  \end{center}
  % \hspace{8pt}\textbf{\fontsize{14pt}{0pt}\selectfont Đề tài:}
  \begin{center}
       \textbf{\fontsize{20pt}{0pt}\selectfont HỖ TRỢ XÂY DỰNG ỨNG DỤNG QUẢN LÝ } \\
       \textbf{\fontsize{20pt}{0pt}\selectfont CÔNG VIỆC PANCAKE CHAT}
  
  \vspace{1.5cm}
  
  \textbf{\fontsize{16pt}{0pt}\selectfont ĐỒNG MINH THÁI} \\

  thai.dm193098@sis.hust.edu.vn
  
  \textbf{\fontsize{16pt}{0pt}\selectfont Lớp: Điện tử 03 - K64}
  % \textbf{\fontsize{16pt}{0pt}\selectfont Ngành Kỹ thuật Điện tử - Viễn thông} \\
