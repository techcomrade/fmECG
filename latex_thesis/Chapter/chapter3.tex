...
\subsubsection{Sơ đồ thiết kế ERD}

\begin{figure}[H]
  \centering
  \includegraphics[width=15cm,height=15cm]{Images/system/fmECG_database.png}
  \caption[Sơ đồ thiết kế ERD]{\bfseries \fontsize{12pt}{0pt}\selectfont Sơ đồ thiết kế ERD}
...
\begin{figure}[H]
  ...
  \caption[Giao diện quản lý phân công bác sĩ - bệnh nhân]{\bfseries \fontsize{12pt}{0pt}\selectfont Giao diện trang quản lý phân công bác sĩ - bệnh nhân}
  \label{pdaTable} %đặt tên cho ảnh
\end{figure}

Hình \ref{pdaTable} mô tả giao diện cho màn hình quản lý phân công bác sĩ - bệnh nhân, trang này sẽ có giao diện để hiển thị danh sách phân công giống với các trang quản lý khác. 
...
\begin{figure}[H]
  ...
  \caption[Sơ đồ tuần tự cho API đăng nhập ]{\bfseries \fontsize{12pt}{0pt}
  \selectfont Sơ đồ tuần tự cho API đăng nhập }
