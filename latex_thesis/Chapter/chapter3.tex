...
\begin{enumerate}[a)]
  ...
  \begin{table}[H]
    ...
    api/auth/register     &   POST    & Đăng ký tài khoản và thông tin người dùng (lưu dữ liệu vào bảng tạm registers) \\ \hline
    api/auth/login        &   POST    & Đăng nhập vào tài khoản \\ \hline
    api/register/update   &   POST    & Cập nhật tài khoản và thông tin người dùng trong bảng registers \\ \hline
    api/register/accepted &   POST    & Chấp nhận đăng ký (lưu dữ liệu này vào bảng account và user, xóa dữ liệu ở bảng registers)\\ \hline
    api/register/rejected &   POST    & Từ chối đăng ký \\ \hline
    api/auth/login   &  POST   & Đăng nhập vào hệ thống \\ \hline
    api/auth         &  GET    & Lấy tất cả thông tin về tài khoản của người dùng (ID tài khoản, email, password) \\ \hline
    api/register     &  GET    & Lấy tất cả thông tin về người dùng trong bảng registers \\ \hline
    \end{tabularx}
  ...
  \begin{table}[H]
    ...
    \hline
    \bfseries Đường dẫn    &\bfseries Phương thức    &\bfseries Mô tả\\ \hline
    api/user  &   POST &  Đăng ký thông tin người dùng \\ \hline
    api/user/update  &  POST   &  Cập nhật thông tin người dùng \\ \hline
    api/user/upload  &  POST   &  Tải ảnh lên theo id người dùng \\ \hline
    api/user  &   GET  &  Lấy thông tin tất cả người dùng \\ \hline
    api/user/id/\{:id\}  &   GET     & Lấy thông tin người dùng cụ thể theo id người dùng \\ \hline
    api/user/role/\{:role\}  &   GET     & Lấy thông tin người dùng cụ thể theo quyền \\ \hline
    api/user/delete  &  DELETE &  Xóa thông tin người dùng theo id người dùng \\ \hline
