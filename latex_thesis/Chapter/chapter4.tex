...
ReactJs sử dụng ngôn ngữ lập trình JavaScript, là một ngôn ngữ hiện đại và linh hoạt, giúp tạo ra các giao diện đẹp mắt và hiệu ứng mượt mà trên môi trường trình duyệt Internet.\cite{reactjs}
\begin{figure}[H]
  \centering
...
trang web hoặc dịch vụ của họ.\cite{openai}
...
CI/CD là viết tắt của Continuous Integration (CI) và Continuous Delivery (CD). Có thể hiểu nó được kết hợp bởi quy trình Tích hợp liên tục và Phân phối liên tục. CI/CD giúp tạo ra sản phẩm cuối cùng nhanh chóng dựa trên kết hợp công việc của mỗi cá nhân.\cite{cicd}
