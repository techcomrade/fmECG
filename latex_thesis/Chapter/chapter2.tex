...
\subsubsection{Use case chức năng đăng ký tài khoản}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_register}, Hình \ref{} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
...
\subsubsection{Use case chức năng quên mật khẩu}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_forgot_password}, Hình \ref{} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
...
\subsubsection{Use case chức năng quản lý tài khoản cá nhân}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_manage_info}, Hình \ref{} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
...
\subsubsection{Use case chức năng xem lịch sử các lần đo}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_record_history}, Hình \ref{getEcgRecordsByUserId}, Hình \ref{getEcgRecordsByDoctor} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
...
\subsubsection{Use case chức năng quản lí dịch vụ nhắn tin}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_chat}, Hình \ref{} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
...
\subsubsection{Use case chức năng tư vấn từ trợ lý ảo}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_chat_ai}, Hình \ref{} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
...
\subsubsection{Use case chức năng quản lý bệnh nhân}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_patient_management}, Hình \ref{} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
...
\subsubsection{Use case chức năng quản lý thiết bị}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_device_management}, Hình \ref{} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
...
\subsubsection{Use case chức năng quản lý tài khoản người dùng}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_user_management}, Hình \ref{} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
