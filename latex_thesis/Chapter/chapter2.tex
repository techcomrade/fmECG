...
\subsubsection{Use case chức năng quản lý tài khoản người dùng}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_list_user}, Hình \ref{sequence_manage_user}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng xem danh sách tài khoản người dùng
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=6cm]{Images/activity/activity_manage_user.png}
    \caption[Sơ đồ hoạt động chức năng xem danh sách người dùng]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng xem danh sách người dùng}
    \label{activity_list_user} %đặt tên cho ảnh
  \end{figure}
...
\subsubsection{Thẻ CRC lớp Người dùng}
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|}
      ...
      Toàn thể - Bộ phận (Aggregation): Thiết bị, Bản ghi
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Thiết bị & \textbf{ID:} 2 \\
      \hline
...
\subsubsection{Thẻ CRC lớp Bản ghi}
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Bản ghi & \textbf{ID:} 3 \\
      \hline
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Tài khoản & \textbf{ID:} 4 \\
      \hline
...
\subsubsection{Thẻ CRC lớp Tài khoản phê duyệt}
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Tài khoản phê duyệt & \textbf{ID:} 4 \\
      \hline
...
\subsubsection{Thẻ CRC lớp Phân công bác sĩ - bệnh nhân}
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Phân công bác sĩ - bệnh nhân & \textbf{ID:} 5 \\
      \hline
...
\subsubsection{Thẻ CRC lớp Token đăng nhập}
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Token đăng nhập & \textbf{ID:} 6  \\
      \hline
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Tin tức & \textbf{ID:} 6 \\
      \hline
    ...
    \begin{tabularx}{0.9\textwidth}{|X|}
      ...
      Liên kết (Association): Người dùng, Danh mục tin tức
      \\
      \hline
    \end{tabularx}
  \end{table}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Danh mục tin tức & \textbf{ID:} 6 \\
      \hline
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Thành viên tham gia hội thoại & \textbf{ID:} 6 \\
      \hline
    ...
    \begin{tabularx}{0.9\textwidth}{|X|}
      ...
      Liên kết (Association): Người dùng, Thông tin hội thoại
      \\
      \hline
    \end{tabularx}
  \end{table}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Thông tin hội thoại & \textbf{ID:} 6 \\
      \hline
      \textbf{Mô tả:} Đối tượng mô tả thông tin Thành viên tham gia hội thoại & \textbf{Use case liên quan:} Quản lý dịch vụ nhắn tin, Hỏi, tư vấn từ trợ lý ảo \\
      \hline
      \textbf{Trách nhiệm (Responsibility):} & \textbf{Các lớp liên quan (Collaboration):} \\
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Tin nhắn & \textbf{ID:} 6 \\
      \hline
      ...
      Gửi tin nhắn
      & 
      Thành viên tham gia hội thoại, Thông tin hội thoại 
    ...
    \begin{tabularx}{0.9\textwidth}{|X|}
      ...
      Liên kết (Association): Thành viên tham gia hội thoại, Thông tin hội thoại, Tệp đính kèm 
      \\
      \hline
    \end{tabularx}
  \end{table}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Tệp đính kèm & \textbf{ID:} 6 \\
      \hline
      ...
      & 
      Tin nhắn, Thông tin cuộc hội thoại
      \\
      \hline
    \end{tabularx}
    \begin{tabularx}{0.9\textwidth}{X}
    ...
    \begin{tabularx}{0.9\textwidth}{|X|}
      ...
      Liên kết (Association): Tin nhắn, Thông tin cuộc hội thoại 
      \\
      \hline
    \end{tabularx}
  \end{table}
...
Để phân tích cụ thể hơn về từng luồng trong hệ thống thông qua sơ đồ use case và sơ đồ hoạt động, chúng em xin phép
...
\begin{figure}[H]
  \centering
  \includegraphics[width=13cm,height=10cm]{Images/sequence/sequence_manage_patient.png}
