...
\subsubsection{Use case chức năng quên mật khẩu}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=20cm]{Images/activity/activity_forgot_pass.png}
...
\subsubsection{Use case chức năng quản lý bệnh nhân}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_add_patient}, Hình \ref{sequence_manage_patient}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  \begin{table}[H]
    \caption{\bfseries \fontsize{12pt}{0pt}\selectfont Bảng phân tích use case chức năng thêm bệnh nhân}
    \centering
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      \hline
      \textbf{Tên chức năng} & \textbf{Thêm bệnh nhân} \\
      \hline
      Tác nhân & Bác sĩ \\
      \hline
      Mô tả & Cho phép bác sĩ thực hiện hành động thêm bệnh nhân của mình \\
      \hline
      Điều kiện trước & Người dùng cần có kết nối Internet và đã đăng nhập \\
      \hline
      Dòng sự kiện chính & 
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng xem/thêm bệnh nhân
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=14cm]{Images/activity/activity_add_patient.png}
    \caption[Sơ đồ hoạt động chức năng xem/thêm bệnh nhân]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng xem/thêm bệnh nhân}
    \label{activity_add_patient} %đặt tên cho ảnh
  \end{figure}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_edit_patient}, Hình \ref{sequence_manage_edit_patient}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_edit_patient}, Hình \ref{sequence_manage_delete_patient}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng sửa/xóa bệnh nhân
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=17cm]{Images/activity/activity_edit_patient.png}
    \caption[Sơ đồ hoạt động chức năng sửa/xóa bệnh nhân]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng sửa/xóa bệnh nhân}
    \label{activity_edit_patient}
  \end{figure}
