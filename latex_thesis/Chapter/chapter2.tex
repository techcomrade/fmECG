...
\subsubsection{Use case chức năng hỏi, nhận tư vấn từ trợ lý ảo}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Tác nhân & Bệnh nhân \\
      \hline
      Mô tả & Cho phép bác sĩ thực hiện hành động xem danh sách bác sĩ phụ trách mình \\
      \hline
      Điều kiện trước & Người dùng cần có kết nối Internet và đã đăng nhập \\
      \hline
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_list_doctor}, Hình \ref{sequence_manage_patient}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng xem danh sách bác sĩ
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=9cm]{Images/activity/activity_manage_doctor.png}
    \caption[Sơ đồ hoạt động chức năng xem danh sách bác sĩ]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng xem danh sách bác sĩ}
    \label{activity_list_doctor} %đặt tên cho ảnh
  \end{figure}
...
\subsubsection{Thẻ CRC lớp Phân công bác sĩ - bệnh nhân}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \hline
      \textbf{Tên lớp:} Thông tin hội thoại & \textbf{ID:} 11 \\
      \hline
      \textbf{Mô tả:} Đối tượng mô tả thông tin Thành viên tham gia hội thoại & \textbf{Use case liên quan:} Quản lý dịch vụ nhắn tin, Hỏi, tư vấn từ trợ lý ảo \\
      \hline
      \textbf{Trách nhiệm (Responsibility):} & \textbf{Các lớp liên quan (Collaboration):} \\
...
\begin{itemize}
  \item Người dùng (\textbf{ID người dùng}, ID tài khoản, Tên người dùng, Ngày sinh, Giới tính, Số điện thoại, Quyền, Trạng thái, Đường dẫn lưu trữ ảnh, Thông tin người dùng)
...
\subsubsection{Chuẩn hoá bảng Tài khoản}
