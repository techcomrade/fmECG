...
\paragraph{Chức năng kết nối và nhận/lưu dữ liệu từ thiết bị điện tim}
\mbox{}
...
\begin{enumerate} [a)]
  \item Định nghĩa cấu trúc gói dữ liệu
    ...
    % //FIXME: HẠNH: hỏi về electrosope và xin ref
    ...
    \begin{figure}[H]
      ...
      \caption[Cấu trúc dữ liệu gói của]{\bfseries \fontsize{12pt}{0pt}
      \selectfont Cấu trúc dữ liệu gói của}
      \label{data_packet_ecg} %đặt tên cho ảnh
    \end{figure}

    % //FIXME: Xin anh Nam về cấu trúc gói datasheet ref
  ...
  \item Xử lý gói dữ liệu
    ...
    Datasheet.
    % //FIXME: datasheet ref hoir Hanhj
...
% //TODO: Thêm các bảng tin nhắn và giải thích ở chương 2 trong mục phân tích dữ liệu
