...
nếu kết quả trả về của server là đúng, sẽ lưu dữ liệu đăng nhập của người dùng vào trong Shared Preferences. Khi tắt và mở lại app,
...
\paragraph{Chức năng kết nối và thực hiện đo với thiết bị điện tim}
\mbox{}
