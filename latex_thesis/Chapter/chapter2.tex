...
\subsubsection{Use case chức năng quên mật khẩu}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=21cm]{Images/activity/activity_forgot_pass.png}
...
\subsubsection{Use case chức năng xem lịch sử các lần đo}
  ...
  \end{figure}
  \begin{table}[H]
    \caption{\bfseries \fontsize{12pt}{0pt}\selectfont Bảng phân tích use case chức năng Sửa thông tin bản ghi dữ liệu đo}
    \centering
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      \hline
      \textbf{Tên chức năng} & \textbf{Sửa thông tin bản ghi dữ liệu đo} \\
      \hline
      Tác nhân & Bác sĩ, Quản trị viên \\
      \hline
      Mô tả & Cho phép bác sĩ sửa  thông tin bản ghi dữ liệu đo của bệnh nhân
      mà mình quản lý, quản trị viên có thể sửa thông tin bản ghi dữ liệu bất kì.\\
      \hline
      Điều kiện trước & Người dùng cần có kết nối Internet và đã đăng nhập \\
      \hline
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_edit_record}, Hình \ref{sequence_edit_record} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  \end{table}
  Dưới đây là sơ đồ hoạt động mô tả chức năng tải bản ghi dữ liệu đo
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=14cm]{Images/activity/activity_edit_record.png}
    \caption[Sơ đồ hoạt động chức năng sửa thông tin bản ghi dữ liệu đo]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng sửa thông tin bản ghi dữ liệu đo}
    \label{activity_edit_record} %đặt tên cho ảnh
  \end{figure}
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_download_record}, Hình \ref{sequence_manage_record} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=10cm]{Images/activity/activity_download_record.png}
    \caption[Sơ đồ hoạt động chức năng tải bản ghi dữ liệu đo]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng tải bản ghi dữ liệu đo}
    \label{activity_download_record} %đặt tên cho ảnh
  \end{figure}
...
\subsubsection{Use case chức năng xem danh sách bệnh nhân}
  \begin{figure}[H]
    \centering
    \includegraphics[width=11cm,height=4.5cm]{Images/use_case/use_case_manage_patients.png}
    \caption[Sơ đồ use case chức năng xem danh sách bệnh nhân]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ use case chức năng xem danh sách bệnh nhân}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_list_patient}, Hình \ref{sequence_manage_patient}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng xem danh sách bệnh nhân
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=9cm]{Images/activity/activity_manage_patient.png}
    \caption[Sơ đồ hoạt động chức năng xem danh sách bệnh nhân]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng xem danh sách bệnh nhân}
    \label{activity_list_patient} %đặt tên cho ảnh
  \end{figure}
...
\subsubsection{Use case chức năng quản lý thiết bị}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_add_device}, Hình \ref{sequence_manage_device} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_add_device}, Hình \ref{sequence_manage_add_device}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng xem/thêm thiết bị
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=13cm]{Images/activity/activity_add_device.png}
    \caption[Sơ đồ hoạt động chức năng xem/thêm thiết bị]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng xem/thêm thiết bị}
    \label{activity_add_device} %đặt tên cho ảnh
  \end{figure}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_edit_device}, Hình \ref{sequence_manage_edit_device}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_edit_device}, Hình \ref{sequence_manage_delete_device}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng sửa/xóa thiết bị
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=17cm]{Images/activity/activity_edit_device.png}
    \caption[Sơ đồ hoạt động chức năng sửa/xóa thiết bị]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng sửa/xóa thiết bị}
    \label{activity_edit_device} %đặt tên cho ảnh
  \end{figure}

\subsubsection{Use case chức năng quản lý phân công bác sĩ - bệnh nhân}
  \begin{figure}[H]
    \centering
    \includegraphics[width=12cm,height=11.5cm]{Images/use_case/use_case_manage_pda.png}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_add_pda}, Hình \ref{sequence_manage_pda}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Tác nhân & Quản trị viên \\
      \hline
      Mô tả & Cho phép quản trị thực hiện hành động thêm phân công bác sĩ - bệnh nhân \\
      \hline
      Điều kiện trước & Người dùng cần có kết nối Internet và đã đăng nhập \\
      \hline
      Dòng sự kiện chính & 
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng xem/thêm phân công bác sĩ - bệnh nhân
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=13cm]{Images/activity/activity_add_pda.png}
    \caption[Sơ đồ hoạt động chức năng xem/thêm người dùng]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng xem/thêm người dùng}
    \label{activity_add_pda} %đặt tên cho ảnh
  \end{figure}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Tác nhân & Quản trị viên \\
      \hline
      Mô tả & Cho phép quản trị thực hiện hành động sửa thông tin phân công bác sĩ - bệnh nhân \\
      \hline
      Điều kiện trước & Người dùng cần có kết nối Internet và đã đăng nhập \\
      \hline
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_edit_pda}, Hình \ref{sequence_manage_edit_pda}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Tác nhân & Quản trị viên \\
      \hline
      Mô tả & Cho phép quản trị thực hiện hành động xóa phân công bác sĩ - bệnh nhân \\
      \hline
      Điều kiện trước & Người dùng cần có kết nối Internet và đã đăng nhập \\
      \hline
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_edit_pda}, Hình \ref{sequence_manage_delete_user} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng sửa/xóa phân công bác sĩ - bệnh nhân
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=17cm]{Images/activity/activity_edit_pda.png}
    \caption[Sơ đồ hoạt động chức năng sửa/xóa phân công bác sĩ - bệnh nhân]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng sửa/xóa phân công bác sĩ - bệnh nhân}
    \label{activity_edit_pda} %đặt tên cho ảnh
  \end{figure}
...
\subsubsection{Use case chức năng quản lý tài khoản người dùng}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_add_user}, Hình \ref{sequence_manage_user}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_add_user}, Hình \ref{sequence_manage_add_user}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng xem/thêm người dùng
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=13cm]{Images/activity/activity_add_user.png}
    \caption[Sơ đồ hoạt động chức năng xem/thêm người dùng]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng xem/thêm người dùng}
    \label{activity_add_user} %đặt tên cho ảnh
  \end{figure}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_edit_user}, Hình \ref{sequence_manage_edit_user}
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|c|X|}
      ...
      Dòng sự kiện chính & 
      % \begin{tabular}{@{}l@{}}
        Chi tiết luồng sự kiện được thể hiện ở Hình \ref{activity_edit_user}, Hình \ref{sequence_manage_delete_user} 
        \\
      % \end{tabular} \\
      \hline
    \end{tabularx}
  ...
  Dưới đây là sơ đồ hoạt động mô tả chức năng sửa/xóa người dùng
  \begin{figure}[H]
    \centering
    \includegraphics[width=13.5cm,height=17cm]{Images/activity/activity_edit_user.png}
    \caption[Sơ đồ hoạt động chức năng sửa/xóa người dùng]{\bfseries \fontsize{12pt}{0pt}
    \selectfont Sơ đồ hoạt động chức năng sửa/xóa người dùng}
    \label{activity_edit_user} %đặt tên cho ảnh
  \end{figure}
...
\subsubsection{Thẻ CRC lớp Người dùng}
  \begin{table}[H]
    ...
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \textbf{Description:} Đối tượng mô tả thông tin người dùng & \textbf{Associated use case:} 4 \\
      \hline
  ...
  \begin{table}[H]
    ...
    \end{tabularx}
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \textbf{Description:} Đối tượng mô tả thông tin thiết bị & \textbf{Associated use case:} 4 \\
      \hline
      \textbf{Responsibility:} & \textbf{Collaboration:} \\
...
\subsubsection{Thẻ CRC lớp Bản ghi}
  \begin{table}[H]
    ...
    \end{tabularx}
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \textbf{Description:} Đối tượng mô tả thông tin bản ghi & \textbf{Associated use case:} 4 \\
      \hline
      \textbf{Responsibility:} & \textbf{Collaboration:} \\
  ...
  \begin{table}[H]
    ...
    \end{tabularx}
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \textbf{Description:} Đối tượng mô tả thông tin tài khoản & \textbf{Associated use case:} 3 \\
      \hline
      \textbf{Responsibility:} & \textbf{Collaboration:} \\
...
\subsubsection{Thẻ CRC lớp Token đăng nhập}
  \begin{table}[H]
    ...
    \end{tabularx}
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \textbf{Description:} Đối tượng mô tả thông tin token tài khoản & \textbf{Associated use case:} 2 \\
      \hline
      \textbf{Responsibility:} & \textbf{Collaboration:} \\
  ...
  \begin{table}[H]
    ...
    \end{tabularx}
    \begin{tabularx}{0.9\textwidth}{|X|X|}
      \textbf{Description:} Đối tượng mô tả thông tin Thành viên tham gia hội thoại & \textbf{Associated use case:} 1 \\
      \hline
      \textbf{Responsibility:} & \textbf{Collaboration:} \\
...
\subsection{Sơ đồ lớp}
  ...
  \begin{itemize}
    \item Lớp Account: Lớp thể hiện cho cấu trúc của một account khi đăng ký sử dụng hệ thống, cung cấp các hàm và các biến để thực hiện chức năng đăng ký người dùng
    \item Lớp Register: Lớp thể hiện cho cấu trúc của người dùng khi mới đăng ký, cung cấp các hàm, phương thức thao tác dữ liệu người dùng khi mới đăng ký
    \item Lớp User: Lớp thể hiện cho cấu trúc của người dùng sau khi đã đăng ký, cung cấp các hàm, phương thức liên quan đến dữ liệu người dùng sau đăng ký
    ...
    \item Lớp PatientDoctorAssignment: Lớp thể hiện cho cấu trúc của một bảng phân công giữa bệnh nhân và bác sĩ, cung cấp các hàm, phương thức để lấy dữ liệu phân công bệnh nhân/bác sĩ
    \item Lớp Record: Lớp thể hiện cho cấu trúc của một bản ghi record, cung cấp các hàm, phương thức để thực hiện liên quan đến các bản ghi dữ liệu sức khỏe của bệnh nhân
    \item Lớp Device: Lớp thể hiện cho cấu trúc của một thiết bị, cung cấp các biến, hàm, phương thức để thực hiện liên quan đến thông tin các thiết bị sử dụng trong các ghi record
    \item Lớp DeviceDetail: Lớp thể hiện cho cấu trúc của chi tiết liên quan đến lớp thiết bị, cung cấp các hàm, phương thức để thực hiện thao tác với dữ liệu các thiết bị và các bản ghi record
    \item Lớp News: Lớp thể hiện cho cấu trúc của một tin tức, cung cấp các hàm, phương thức để lấy dữ liệu tin tức
    \item Lớp NewsCategories: Lớp thể hiện cho cấu trúc của một danh mục tin tức, cung cấp các hàm, phương thức để lấy dữ liệu từ danh mục tin tức
    \item Lớp Conversation: Lớp thể hiện cho cấu trúc của một cuộc hội thoại, cung cấp các biến, hàm, phương thức để lấy dữ liệu liên quan đến cuộc hội thoại
    \item Lớp ConversationMember: Lớp thể hiện cho cấu trúc của danh sách những người tham gia một cuộc hội thoại, cung cấp các hàm, phương thức để xử lý dữ liệu liên quan đến người dùng
    \item Lớp ConversationAttachment: Lớp thể hiện cho cấu trúc của danh sách những tệp được đính kém trong danh sách hội thoại, cung cấp các hàm, phương thức để xử lý các chức năng liên quan đến hội thoại
    \item Lớp Message: Lớp thể hiện cho cấu trúc của một message được sử dụng trong hội thoại, cung cấp các hàm, phương thức để xử lý dữ liệu trong cuộc hội thoại
  \end{itemize}
% \newpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=14cm,height=11cm]{Images/sequence/sequence_manage_record.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=14cm,height=13cm]{Images/sequence/sequence_edit_record.png}
  \caption[Sơ đồ tuần tự chức năng sửa thông tin dữ liệu đo]{\bfseries \fontsize{12pt}{0pt}
  \selectfont Sơ đồ tuần tự chức năng sửa thông tin dữ liệu đo}
  \label{sequence_edit_record} %đặt tên cho ảnh
\end{figure}
Nếu bác sĩ, quản trị viên muốn sửa thông tin dữ liệu đo, bác sĩ và quản trị viên gửi yêu cầu thay đổi, yêu cầu sẽ được xử lý bởi Control, 
nếu có lỗi phát sinh sẽ hiển thị lên màn hình, nếu thay đổi thành công Control sẽ gửi thông báo thành công. 

\begin{figure}[H]
  \centering
  \includegraphics[width=14cm,height=11cm]{Images/sequence/sequence_download_records.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=14cm,height=9cm]{Images/sequence/sequence_chat_ai.png}
...
\subsubsection{Sơ đồ tuần tự chức năng xem danh sách bệnh nhân}
\begin{figure}[H]
  \centering
...
\end{figure}
Sơ đồ tuần tự trên mô tả chi tiết quá trình bác sĩ xem danh sách bệnh nhân trên hệ thống. Bác sĩ chọn mở giao diện quản lý bệnh nhân, 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=14cm,height=11cm]{Images/sequence/sequence_manage_add_pda.png}
...
\end{figure}
Sơ đồ tuần tự trên mô tả chi tiết quá trình quản trị viên xem, tạo, sửa, xóa với danh sách phân công bác sĩ - bệnh nhân trên hệ thống. Quản trị viên chọn mở giao diện
quản lý phân công bác sĩ - bệnh nhân, API sẽ được xử lý bởi Control, hiện danh sách phân công bác sĩ - bệnh nhân. 
\begin{figure}[H]
  \centering
  \includegraphics[width=14cm,height=13cm]{Images/sequence/sequence_manage_edit_pda.png}
...
yêu cầu sẽ được xử lý bởi Control, nếu có lỗi phát sinh sẽ hiển thị lên màn hình, nếu thay đổi thành công Control sẽ gửi thông báo thành công. 
\begin{figure}[H]
  \centering
  \includegraphics[width=14cm,height=12cm]{Images/sequence/sequence_manage_delete_pda.png}
