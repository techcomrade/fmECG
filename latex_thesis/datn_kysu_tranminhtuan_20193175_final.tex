...
% \includepdf[pages={1},scale=1]{PDF/SEEE_Evaluation_Huy.pdf}
% \cleardoublepage
% \includepdf[pages={1},scale=1]{PDF/SEEE_DanhgiaHD_Huy.pdf}
% \cleardoublepage
% \includepdf[pages={1},scale=1]{PDF/SEEE_Danhgia_Huy.pdf}
% \cleardoublepage


\includepdf[pages={1},scale=1]{PDF/SEEE_Danhgiadntn_Tuan.pdf}
\cleardoublepage
\includepdf[pages={1},scale=1]{PDF/SEEE_Danhgiadatn_Huy.pdf}
% \cleardoublepage
