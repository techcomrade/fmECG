...
% Đồ án về đề tài...,
% chính là một nhánh trong hệ thống giúp các mẹ bầu có thể xem được nhịp tim của mình và em bé, được phân công bác sĩ để
% trao đổi trực tiếp tình hình. 
...
\subsubsection{Use case chức năng quản lý bài đăng và nhãn bài đăng}
  \begin{figure}[H]
    \centering
    \includegraphics[width=15cm,height=6cm]{Images/use_case/use_case_news.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=15cm,height=6cm]{Images/use_case/use_case_category_news.png}
...
\subsubsection{Use case chức năng quản lý các bản ghi dữ liệu điện tim}
  \begin{figure}[H]
    \centering
    \includegraphics[width=15cm,height=6cm]{Images/use_case/use_case_manage_records.png}
...
\subsubsection{Use case chức năng quản lý tài khoản người dùng}
  \begin{figure}[H]
    \centering
    \includegraphics[width=15cm,height=6cm]{Images/use_case/use_case_manage_users.png}
