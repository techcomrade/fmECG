...
\end{center}
\vspace{-5pt}
\fontsize{12pt}{20pt}\selectfont Tên đề tài: Phát triển ứng dụng di động tích hợp trong hệ thống quản lý dữ liệu điện tim, hỗ trợ kết nối giữa bác sĩ - bệnh nhân \\
\fontsize{12pt}{20pt}\selectfont Họ tên SV: Trần Xuân Quyến
\hspace{3.5cm} 
\fontsize{12pt}{20pt}\selectfont  MSSV:  20214068\\
