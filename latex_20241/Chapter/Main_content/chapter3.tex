...
Ứng dụng di động sẽ thuộc khối Ứng dụng (Application), nó chịu trách nhiệm việc giao tiếp với khối Máy chủ (hay Server) thông qua giao thức HTTP và các API.
...
PPG (Photoplethysmography) - Quang phổ thể tích là đường màu xanh đỏ, mổ tả sự thay đổi thể tích máu trong mạch máu bằng cách sử dụng ánh sáng.
