...
\begin{figure}[H]
	\centering
	\includegraphics[width=16cm,height=17cm]{Images/api_sequence/device/device-Add.drawio.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12.9cm]{Images/api_sequence/record/createRecord.drawio.png}
