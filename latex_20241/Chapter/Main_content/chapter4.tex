...
Kiến trúc Microservices là một cách tiếp cận trong quy trình phát triển phần mềm, ở đó một ứng dụng lớn được tách thành nhiều dịch vụ nhỏ hoạt động độc lập với nhau.
...
\begin{xltabular}{\textwidth}{
	...
	1. Hiển thị thông báo sai email đăng nhập hoặc mật khẩu truy cập
	...
	1. Truy cập giao diện tạo tài khoản người dùng mới $\rightarrow$ Nhập thông tin tương ứng với tài khoản đã tồn tại
	$\rightarrow$ Nhấn đăng ký

	% \\ &

	2. Truy cập giao diện tạo tài khoản người dùng mới $\rightarrow$ Nhập các thông tin tài khoản hơp lệ
	...
	1. Truy cập trang thông tin bác sĩ
	...
	1. Truy cập trang quản lý thiết bị y tế
	...
	4. Cập nhật thông tin thiết bị y tế thành công
	...
	1. Vào trang quản lý lịch khám cá nhân
	...
	1. Vào trang quản lý lịch khám hoặc xem thông báo
	...
	&
	1. Truy cập trang quản lý thông tin cá nhân
	...
	&
	1. Truy cập trang quản lý dịch vụ tin nhắn
	...
	1. Hiển thị danh sách các đoạn hội thoại
