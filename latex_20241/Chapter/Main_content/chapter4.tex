...
\begin{figure}[H]
	\centering
	\includegraphics[height=3cm]{Images/Technology/flutter_logo.png}
...
\subsubsection{Kiểm thử ứng dụng app}
\clearpage
\begin{xltabular}{\textwidth}{
	| >{\raggedright\arraybackslash}p{2cm}
	| >{\raggedright\arraybackslash}X
	...
	\caption{\bfseries \fontsize{12pt}{0pt}\selectfont Bảng kiểm thử chức năng của app}
	% \label{table_api_news}
	\\
	\hline
