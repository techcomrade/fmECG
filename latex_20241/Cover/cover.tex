\begin{titlepage}
	...
	\begin{center}
		...
		\textbf{\fontsize{16pt}{0pt}\selectfont HỆ THỐNG QUẢN LÝ DỮ LIỆU SỨC KHỎE TIM MẠCH}\\
		\textbf{\fontsize{16pt}{0pt}\selectfont VÀ TƯƠNG TÁC GIỮA BỆNH NHÂN - BÁC SĨ}
		...
		\begin{table}[H]%tạo bảng
			\centering
			\begin{tabular}{l l}
				\fontsize{14pt}{0pt}\selectfont Sinh viên thực hiện:  & \fontsize{14pt}{0pt}\selectfont Cồ Huy Dũng  - 20213834                      \\
