  ...
  class _HomeScreenState extends State<HomeScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ElevatedButton(
              //   onPressed: () {
              //     updateBloodPressure(145, 90, 80);  // Thử nghiệm với giá trị > 140
              //   },
              //   child: Text('Thử Nghiệm Huyết Áp Cao'),
              // ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        NumberCard(
                          number: systolicPressure,
                          text: "Huyết áp tâm thu",
                          subText: "mmHg",
                          color1: systolicPressure > 140 ? Colors.red : ColorConstant.primary,
                          color2: systolicPressure > 140 ? Colors.redAccent : ColorConstant.primary,
                        ),
                        NumberCard(
                          number: diastolicPressure,
                          text: "Huyết áp tâm trương",
                          subText: "mmHg",
                          color1: diastolicPressure > 1 && diastolicPressure < 90 ? Colors.red : ColorConstant.primary,
                          color2: diastolicPressure > 1 && diastolicPressure < 90 ? Colors.redAccent : ColorConstant.primary,
                        ),
                        NumberCard(number: heartRate, text: "Nhịp tim", subText: "bpm", color1: ColorConstant.primary, color2: ColorConstant.quaternary),
    ...
    void updateBloodPressure(int newSystolic, int newDiastolic, int newHeartRate) async {
      setState(() {
        systolicPressure = newSystolic;
        diastolicPressure = newDiastolic;
    ...
    _sendSMS() async {
      if (_phoneController.text.isNotEmpty) {
        ...
        String message = "Cảnh báo $warningEmoji\nHuyết áp người thân cao:\n$systolicPressure/$diastolicPressure so với ngưỡng 140/90";
        await telephony.sendSms(to: _phoneController.text, message: message);
      }
    }
  }
