...
$(document).ready(function () {
    ...
    $("#addtask").click(function(){
        ...
        for (i = 0; i < taskassignee.length; i++) {
            src=src+'<div class="avatar-group-item"><a href="#" class="d-inline-block" value="'+taskassigneevalue[i]+'"><img src="'+taskassignee[i]+'" class="rounded-circle avatar-sm" alt=""></a></div>';
        }
        var statuscolor;
